<?php 
    ...
    $info = isset($_GET["info"]) && !empty($_GET["info"]) ? $_GET["info"] : "test"; 
?>
    <style>
        body {
    ...
    <div class="board">
        <p id="error"><span class="novacancy on">
            ...
            </span><span class="novacancy on">t</span><span class="novacancy on">e</span><span class="novacancy on">s</span><span class="novacancy on">t</span><span class="novacancy on">
            </span></p>
